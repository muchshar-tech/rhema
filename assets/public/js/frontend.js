...
var Form = function Form(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", {
    onSubmit: onSubmit,
    className: "w-full flex flex-col m-0"
  }, children);
};
...
var Top = function Top(_ref2) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "sticky flex flex-wrap items-center text-gray-800 bg-white border-b text-12px md:text-14px drop-shadow-sm"
  }, children);
};
...
var BbileRaws = function BbileRaws(_ref7) {
  ...
  var currentBookIndex = (_readingQuerys$ = readingQuerys[0]) === null || _readingQuerys$ === void 0 || (_readingQuerys$ = _readingQuerys$.book) === null || _readingQuerys$ === void 0 ? void 0 : _readingQuerys$.index;
  if (!currentBookIndex) {
...
var Verses = function Verses() {
  var _stateData$translatio2, _readingQuerys$;
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useDispatch)();
  var stateData = (0,react_redux__WEBPACK_IMPORTED_MODULE_1__.useSelector)(function (state) {
    return state.data;
  });
...
/* harmony import */ var react_loading_skeleton__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-loading-skeleton */ "./node_modules/react-loading-skeleton/dist/index.js");
/* harmony import */ var _assets_js_frontend_utilities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @assets/js/frontend/utilities */ "./assets/src/js/frontend/utilities.js");
...
var _RHEMA_LOCALIZE$RHEMA, _RHEMA_LOCALIZE$RHEMA2, _RHEMA_LOCALIZE$RHEMA3, _RHEMA_LOCALIZE$RHEMA4, _RHEMA_LOCALIZE$RHEMA5;
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
...
var initialState = {
  ...
  translation: {
    abbr: (_RHEMA_LOCALIZE$RHEMA4 = (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_0___default().RHEMA_INITAIL_DATA)) === null || _RHEMA_LOCALIZE$RHEMA4 === void 0 || (_RHEMA_LOCALIZE$RHEMA4 = _RHEMA_LOCALIZE$RHEMA4.TRANSLATION) === null || _RHEMA_LOCALIZE$RHEMA4 === void 0 ? void 0 : _RHEMA_LOCALIZE$RHEMA4.ABBR,
    info: (_RHEMA_LOCALIZE$RHEMA5 = (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_0___default().RHEMA_INITAIL_DATA)) === null || _RHEMA_LOCALIZE$RHEMA5 === void 0 || (_RHEMA_LOCALIZE$RHEMA5 = _RHEMA_LOCALIZE$RHEMA5.TRANSLATION) === null || _RHEMA_LOCALIZE$RHEMA5 === void 0 ? void 0 : _RHEMA_LOCALIZE$RHEMA5.INFO
  }
};
...
var store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__.configureStore)({
  reducer: _defineProperty(_defineProperty({
  ...
  }, _services__WEBPACK_IMPORTED_MODULE_0__.bibleApi.reducerPath, _services__WEBPACK_IMPORTED_MODULE_0__.bibleApi.reducer), _services__WEBPACK_IMPORTED_MODULE_0__.searchApi.reducerPath, _services__WEBPACK_IMPORTED_MODULE_0__.searchApi.reducer),
...
/* harmony import */ var _assets_js_frontend_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @assets/js/frontend/store */ "./assets/src/js/frontend/store.js");
...
var generateVerseUrl = function generateVerseUrl(bookAbbr, chapter, number) {
  return (0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.generatePath)('/bible/:books/:verse', {
    books: bookAbbr,
...
var retrieveBookIndexBySlug = function retrieveBookIndexBySlug(slug) {
  var getState = _assets_js_frontend_store__WEBPACK_IMPORTED_MODULE_1__.store.getState;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          dispatch = _assets_js_frontend_store__WEBPACK_IMPORTED_MODULE_1__.store.dispatch, getState = _assets_js_frontend_store__WEBPACK_IMPORTED_MODULE_1__.store.getState;
