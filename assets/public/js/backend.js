...
var Settings = function Settings() {
  var _updateOptionsRespons, _updateOptionsError$d, _updateOptionsRespons2, _updateOptionsError$d2, _updateOptionsRespons3;
  ...
  var showExceptionMessage = !!updateOptionsResponse && !/2[0-9][0-9]/.test(updateOptionsResponse === null || updateOptionsResponse === void 0 || (_updateOptionsRespons = updateOptionsResponse.response) === null || _updateOptionsRespons === void 0 ? void 0 : _updateOptionsRespons.code) || !!updateOptionsError;
  ...
  var exceptionMessage = {
    ...
    label: '',
    message: (updateOptionsError === null || updateOptionsError === void 0 || (_updateOptionsError$d = updateOptionsError.data) === null || _updateOptionsError$d === void 0 ? void 0 : _updateOptionsError$d.message) || 'There has been a critical error.'
  };
  var successMessage = {
    code: (updateOptionsResponse === null || updateOptionsResponse === void 0 || (_updateOptionsRespons2 = updateOptionsResponse.response) === null || _updateOptionsRespons2 === void 0 ? void 0 : _updateOptionsRespons2.code) || 200,
    label: 'Success',
    message: (updateOptionsError === null || updateOptionsError === void 0 || (_updateOptionsError$d2 = updateOptionsError.data) === null || _updateOptionsError$d2 === void 0 || (_updateOptionsError$d2 = _updateOptionsError$d2.data) === null || _updateOptionsError$d2 === void 0 ? void 0 : _updateOptionsError$d2.message) || (updateOptionsResponse === null || updateOptionsResponse === void 0 || (_updateOptionsRespons3 = updateOptionsResponse.data) === null || _updateOptionsRespons3 === void 0 ? void 0 : _updateOptionsRespons3.message) || 'Rhema options saved.'
  };
...
var License = function License(_ref4) {
  ...
  var responseMessage = function (activateResponse, deactivateResponse, activateError, deactivateError, _deactivateError$data, _deactivateError$data2, _activateError$data, _deactivateError$data3) {
    ...
    var label = activateResponse !== null && activateResponse !== void 0 && activateResponse.success ? 'seccess' :  false || activateError !== null && activateError !== void 0 && activateError.data.code || deactivateResponse !== null && deactivateResponse !== void 0 && deactivateResponse.success ? 200 :  false || (deactivateError === null || deactivateError === void 0 || (_deactivateError$data = deactivateError.data) === null || _deactivateError$data === void 0 ? void 0 : _deactivateError$data.code) || (deactivateError === null || deactivateError === void 0 || (_deactivateError$data2 = deactivateError.data[0]) === null || _deactivateError$data2 === void 0 ? void 0 : _deactivateError$data2.code) || '';
    var message = /5[0-9][0-9]/.test(code) ? 'There has been a critical error.' : (activateResponse === null || activateResponse === void 0 ? void 0 : activateResponse.body) || (activateError === null || activateError === void 0 || (_activateError$data = activateError.data) === null || _activateError$data === void 0 ? void 0 : _activateError$data.message) || (deactivateError === null || deactivateError === void 0 || (_deactivateError$data3 = deactivateError.data) === null || _deactivateError$data3 === void 0 ? void 0 : _deactivateError$data3.message);
    return {
      code: code,
      label: label,
      message: message
...
var LoginCard = function LoginCard(_ref) {
  ...
  var responseMessage = function (signinResponse, signinError, _signinResponse$data, _signinError$data, _signinError$data2) {
    ...
    var message = /2[0-9][0-9]/.test(code) ? (signinResponse === null || signinResponse === void 0 || (_signinResponse$data = signinResponse.data) === null || _signinResponse$data === void 0 ? void 0 : _signinResponse$data.message) || 'Signin success!' : (signinError === null || signinError === void 0 || (_signinError$data = signinError.data) === null || _signinError$data === void 0 ? void 0 : _signinError$data.message) || (signinError === null || signinError === void 0 || (_signinError$data2 = signinError.data) === null || _signinError$data2 === void 0 || (_signinError$data2 = _signinError$data2.data) === null || _signinError$data2 === void 0 ? void 0 : _signinError$data2.message) || 'There has been a critical error.';
    return {
      code: code,
      label: label,
      message: message
...
var VerifyEmailCard = function VerifyEmailCard(_ref2) {
  ...
  var responseMessage = function (response, error, _response$data, _error$data, _error$data2) {
    ...
    var message = /2[0-9][0-9]/.test(code) ? (response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.message) || 'Signin success!' : (error === null || error === void 0 || (_error$data = error.data) === null || _error$data === void 0 ? void 0 : _error$data.message) || (error === null || error === void 0 || (_error$data2 = error.data) === null || _error$data2 === void 0 || (_error$data2 = _error$data2.data) === null || _error$data2 === void 0 ? void 0 : _error$data2.message) || 'There has been a critical error.';
    return {
      code: code,
      label: label,
      message: message
...
var ForgotPasswordCard = function ForgotPasswordCard(_ref3) {
  ...
  var showExceptionMessage = !!response && !(response !== null && response !== void 0 && response.success) || !!error;
  var responseMessage = function (response, error, _response$data2, _error$data3, _error$data4) {
    var code = (response === null || response === void 0 ? void 0 : response.success) === true ? 200 :  false || (error === null || error === void 0 ? void 0 : error.status);
    var label = (response === null || response === void 0 ? void 0 : response.success) === true ? 'Success' :  false || (error === null || error === void 0 ? void 0 : error.data.code) || '';
    var message = /2[0-9][0-9]/.test(code) ? (response === null || response === void 0 || (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.message) || 'Signin success!' : (error === null || error === void 0 || (_error$data3 = error.data) === null || _error$data3 === void 0 ? void 0 : _error$data3.message) || (error === null || error === void 0 || (_error$data4 = error.data) === null || _error$data4 === void 0 || (_error$data4 = _error$data4.data) === null || _error$data4 === void 0 ? void 0 : _error$data4.message) || 'There has been a critical error.';
    return {
      code: code,
      label: label,
      message: message
...
var store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__.configureStore)({
  reducer: _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
  ...
  }, _components_services__WEBPACK_IMPORTED_MODULE_0__.optionsApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.optionsApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.activateApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.activateApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.deactivateApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.deactivateApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.signinApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.signinApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.sendVerifyApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.sendVerifyApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.sendForgotApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.sendForgotApi.reducer), _components_services__WEBPACK_IMPORTED_MODULE_0__.ordersApi.reducerPath, _components_services__WEBPACK_IMPORTED_MODULE_0__.ordersApi.reducer),
...
var prepareHeaders = function prepareHeaders(headers) {
  ...
  var nonce = ((RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default()) === null || (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default()) === void 0 || (_RHEMA_LOCALIZE$RHEMA = (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default().RHEMA_BACKEND)) === null || _RHEMA_LOCALIZE$RHEMA === void 0 ? void 0 : _RHEMA_LOCALIZE$RHEMA.NONCE) || ((RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default()) === null || (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default()) === void 0 || (_RHEMA_LOCALIZE$RHEMA2 = (RHEMA_LOCALIZE__WEBPACK_IMPORTED_MODULE_1___default().RHEMA_INITAIL_DATA)) === null || _RHEMA_LOCALIZE$RHEMA2 === void 0 ? void 0 : _RHEMA_LOCALIZE$RHEMA2.NONCE);
  if (nonce) {
