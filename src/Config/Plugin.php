...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'rhema_plugin_data', [
			'settings'               => get_option( 'rhema-settings' ),
			'plugin_path'            => untrailingslashit(
				plugin_dir_path( RHEMA_PLUGIN_FILE )  // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
			),
			'plugin_template_folder' => 'templates',
			'ext_template_folder'    => 'rhema-templates',
			/**
			 * Add extra data here
			 */
		] );
		return array_merge(
			apply_filters( 'rhema_plugin_meta_data',
				get_file_data( RHEMA_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
